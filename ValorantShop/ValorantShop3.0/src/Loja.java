...
public class Loja {
    ...
    public static void main(String[] args) throws Exception {
        ...
        acessorios.add(new Poster("Revive-me, Jett?", 345, 20, 40));
        acessorios.add(new Poster("Valorant Go!", 400, 10, 20));
        acessorios.add(new Poster("Chill-Joy", 200, 20, 40));
        acessorios.add(new Poster("Versus - Phoenix + Jett", 140, 10, 10));

        acessorios.add(new Chaveiros("Soberania", 300, "Gota"));
        acessorios.add(new Chaveiros("Orbe de Radianita", 150, "Esfera"));
        acessorios.add(new Chaveiros("Moeda", 100, "Círculo"));
        acessorios.add(new Chaveiros("Chapéu Branco", 200, "Chapéu"));
            ...
            switch(op){
                ...
                //ADICIONAR AO CARRINHO
                    ...
                    if(c1.getCadastro()){
                        ...
                        try{
                            ...
                            //PARA ACESSORIOS
                            if(codigo_carrinho >= Produto.max_produtos){
                                clear_menu();
                                System.out.println("\n\n\n-> INFORMAÇÕES DO PRODUTO: \n"); 
                                acessorios.get(codigo_carrinho - Produto.max_produtos).imprimeInformacoes();

                                ca1.adicionarProduto(acessorios.get(codigo_carrinho - Produto.max_produtos).getValor());
                                Carrinho.info();

                            //PARA PRODUTOS COMUNS
                            }else {
                                clear_menu();
                ...
                case 10:
                    ...
                    if(g1.getCadastro()){
                        ...
                        int codigo_remover = ent.nextInt();

                        try {
                            verificaRemoverOuAlterar(codigo_remover);
                ...
                case 11:
                    ...
                    if(g1.getCadastro()){
                        ...
                        try {
                            verificaRemoverOuAlterar(codigo_alterar);
    ...
    public static void verificaRemoverOuAlterar(int codigo) throws Exception {

        if(codigo >= Produto.max_produtos) {
            throw new Exception("[ NAO PERMITIDO ] - não é possivel alterar/remover produtos que ainda não estão na loja física");
        }

        else if(codigo < Produto.max_produtos && codigo >= Produto.quantidade_produtos) {
            throw new Exception("[ NAO PERMITIDO ] - não é possivel alterar/remover produtos que ainda não foram cadastrados");
        }
    }
}
